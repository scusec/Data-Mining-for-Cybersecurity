# -*- coding: utf-8 -*-
from peewee import MySQLDatabase, Model, CharField, BooleanField, IntegerField,TextField
import json
...
class WB(BaseModel):
    ...
    content = TextField()
    sentiment = CharField()
    segmentation = TextField()
    positive_prob = CharField()
    confidence = CharField()
    negative_prob = CharField()
