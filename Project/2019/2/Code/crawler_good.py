...
for i in range(0, 1463):
    url = 'https://samate.nist.gov/SARD/view.php?count=20&languages[]=PHP&flawed[]=Good&status_Candidate=1&status_Accepted=1&sort=desc&first='
    url += str(i*20)
    print(url)
...
file_path = '/Users/devin/Desktop/xss_php_good/'
file_list = []
